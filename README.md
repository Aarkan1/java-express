...
[Latest java-express-1.0.11.jar](https://github.com/Aarkan1/java-express/raw/main/releases/java-express-1.0.11.jar)
...
dependencies {
    implementation 'com.github.Aarkan1:java-express:1.0.11'
}
```
...
app.useSinglePageApp(String url, Path filePath)         // Route 404's to target file, good for SPA's
app.useSinglePageApp(String url, String filePath, Location location) // Route 404's to target file in classpath (Location.CLASSPATH)
