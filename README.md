...
[Latest java-express-1.1.1.jar](https://github.com/Aarkan1/java-express/raw/main/releases/java-express-1.1.1.jar)
...
dependencies {
    implementation 'com.github.Aarkan1:java-express:1.1.1'
}
```
